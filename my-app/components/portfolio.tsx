...
export default function Portfolio() {
  ...
  const fixedId = "canvas-container-static";
  const fixedCanvasId = "canvas-static";
            ...
            <div className="container mx-auto px-6 lg:px-20">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-10 md:p-16">
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 mb-6">
                  ...
                  en la creación de aplicaciones modernas y responsivas. Mi
                  enfoque se centra en proporcionar soluciones eficientes y
                  escalables utilizando las últimas tecnologías del mercado.
                </p>
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  Además, soy Consultor funcional de Dynamic 365 y Power BI,
                  ayudando a las empresas a optimizar sus procesos y tomar
                  decisiones basadas en datos.
                </p>
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  Con una sólida base en React JS, JavaScript, Next.js, CSS3 y
              ...
              {[
                {
                  ...
                  description:
                    "WEB Fundación y Ministerio FUMMHOR es un sitio web desarrollado para una fundación evangélica, diseñado con WordPress y Elementor.",
                ...
                },
                {
                  title: "Andamios Web",
                  description:
                    "Andamios del Este es una página web informativa diseñada para proporcionar detalles sobre los servicios y productos de la empresa. Desarrollada en WordPress y utilizando el constructor visual Divi.",
                ...
                },
                {
                  ...
                  description:
                    "Aplicación de presupuesto es una herramienta web para gestionar y controlar el presupuesto personal. Permite a los usuarios registrar ingresos y gastos, y proporciona gráficos para visualizar el balance financiero.",
                ...
                },
                {
                  ...
                  description:
                    "Este proyecto es un clon de la sección de testimonios de FreeCodeCamp, diseñado para replicar su funcionalidad y estética.",
          ...
          <section id="data-analysis-projects" className="py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                {
                  title:
                    "Mapeo de empleados Análisis de Datos de Atención al Cliente con Python",
                  description:
              ...
              {[
                {
                  ...
                  description:
                    "Técnicas para optimizar el rendimiento en React.",
